...
_initBlogs(var entries) { 
  ...
  blog = new Blog(entries.blogs.concept); 
  blog.link = Uri.parse("http://try.dartlang.org/"); 
  blog.name = "value2"; 
  blog.privacy = "value2"; 
  ...
  blog = new Blog(entries.blogs.concept); 
  blog.link = Uri.parse("http://pub.dartlang.org/"); 
  blog.name = "value7"; 
  blog.privacy = "value7"; 
...
_initAdmins(var entries) { 
  Admin admin = new Admin(entries.admins.concept); 
  admin.privilege = "value0"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value1"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value2"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value3"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value4"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value5"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value6"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value7"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value8"; 
  entries.admins.add(admin); 
 
  admin = new Admin(entries.admins.concept); 
  admin.privilege = "value9"; 
  entries.admins.add(admin); 
