...
class BloggingEntries extends ModelEntries { 
  ...
  Map<String, Entities> newEntries() { 
    ...
    concept = model.concepts.singleWhereCode("Admin"); 
    entries["Admin"] = new Admins(concept); 
    return entries; 
  } 
  ...
  Entities newEntities(String conceptCode) { 
    ...
    if (concept.code == "Admin") { 
      return new Admins(concept); 
    } 
  return null; 
  } 
  ...
  Admins get admins => getEntry("Admin"); 
